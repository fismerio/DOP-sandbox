# This code is based on https://github.com/Its-Triggy/Joint_Track/blob/master/jointTrack.py
# Shown is the video https://www.youtube.com/watch?v=gPeeFCvJOWA
...
class Joint:
    ...
    face_cascade = cv2.CascadeClassifier(
        '/Users/Tristan/Desktop/opencv-3.4.1/data/haarcascades/haarcascade_frontalface_default.xml')
    face_glasses_cascade = cv2.CascadeClassifier(
        '/Users/Tristan/Desktop/opencv-3.4.1/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
    ...
    upper_cascade = cv2.CascadeClassifier(
        '/Users/Tristan/Desktop/opencv-3.4.1/data/haarcascades/haarcascade_upperbody.xml')
    lower_cascade = cv2.CascadeClassifier(
        '/Users/Tristan/Desktop/opencv-3.4.1/data/haarcascades/haarcascade_lowerbody.xml')
    full_cascade = cv2.CascadeClassifier(
        '/Users/Tristan/Desktop/opencv-3.4.1/data/haarcascades/haarcascade_fullbody.xml')
    ...
    def circle(self):
        ...
        if len(jointTrail) == self.trailLength and self.still() == False:
            ...
            if Joint.mag([jointTrail[0][0] - jointTrail[self.trailLength - 1][0],
                          jointTrail[0][1] - jointTrail[self.trailLength - 1][1]]) \
    ...
    def findJoint_HaarMethod(self, gray):
        ...
        if joint_found == False:
            if type == 'head':
                haar = Joint.face_glasses_cascade.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=5,
                                                                   minSize=(30, 30))
